...
class _JobsScreenState extends State<JobsScreen> with SingleTickerProviderStateMixin {
  ...
  String _selectedExperience = 'entry';
  ...
  List<EducationEntry> _educations = [];
  List<CertificateEntry> _certificates = [];
  ...
  Future<void> _searchJobs() async {
    if (_roleController.text.trim().isEmpty) {
      _showError('Please enter a job role');
      return;
    }
    ...
    try {
      final results = await _mentorService.searchJobs(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'AI-powered job search across South Africa',
                        style: GoogleFonts.inter(
                          fontSize: 13,
          ...
          // Search Fields
          Text('Target Role', style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
          const SizedBox(height: 8),
          TextField(
            controller: _roleController,
            decoration: InputDecoration(
              hintText: 'e.g., Software Developer, Data Analyst',
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'e.g., Johannesburg, Cape Town',
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
              filled: true,
              fillColor: Colors.grey[50],
            ),
          ...
          Text('Experience Level', style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
          const SizedBox(height: 8),
          Wrap(
            spacing: 8,
            children: ['entry', 'mid', 'senior'].map((level) => ChoiceChip(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: _isSearching ? null : _searchJobs,
              icon: _isSearching 
                  ? const SizedBox(
                      height: 18,
                      width: 18,
              ...
              label: Text(
                _isSearching ? 'Searching...' : 'Search Jobs',
          ...
          if (_jobResults != null) ...[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${_jobResults!.salaryRange.min} - ${_jobResults!.salaryRange.max} per month',
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemCount: _jobResults!.jobBoards.length,
                itemBuilder: (context, index) {
                  final board = _jobResults!.jobBoards[index];
                  return Padding(
                    padding: const EdgeInsets.only(right: 8),
                    child: ElevatedButton(
                      onPressed: () => _launchUrl(board.searchUrl),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.white,
            ...
            const SizedBox(height: 12),
            ..._jobResults!.jobs.map((job) => _buildJobCard(job)),

            // Tips
            if (_jobResults!.tips.isNotEmpty) ...[
              const SizedBox(height: 24),
              Text(
                '💡 Application Tips',
                style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.bold),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: _jobResults!.tips.map((tip) => Padding(
        ...
        children: [
          ...
          if (job.requirements.isNotEmpty) ...[
            ...
            Wrap(
              spacing: 6,
              runSpacing: 6,
              children: job.requirements.take(3).map((req) => Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                decoration: BoxDecoration(
